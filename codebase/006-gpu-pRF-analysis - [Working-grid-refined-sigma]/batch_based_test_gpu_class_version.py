...
def main():
    ...
    for data_idx in range(len(measured_data)):
        ...
        for current_batch_idx in range(0, total_y_signals, batch_size):
            ...
            refined_matching_results, Fex_results = gpu_fitting(O_gpu, arr_2d_location_inv_M_cpu, Y_signals_batch_gpu, Y_signals_batch_cpu, S_prime_columnmajor_gpu, dS_prime_dx_columnmajor_gpu, dS_prime_dy_columnmajor_gpu, dS_prime_dsigma_columnmajor_gpu)
