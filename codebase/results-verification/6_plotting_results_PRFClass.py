...
###
basePath="Y:\\data\\tests\\oprf_test\\BIDS"
results_base_path = 'D:/results/comparison-plots' # 'Y:/data/tests/oprf_test/derivatives'
run = '01'
task = 'prf'
hemi='BOTH'
...
groundtruth_positions = [(0, 0), (3, -2)]
groundtruth_sigmas = [1, 1.8]
...
# # test - without & with filtering results are in oprf-analysis-03 and oprf-analysis-04 respectively
# #...without filtering
# oprf_without_filtering = PRF.from_docker('', '002', '003', task, '01', analysis='03', hemi=hemi, baseP=basePath, orientation='MP', method='oprf')
# create_and_save_plot(result_path_seperator= slash_or_hyphen, selected_method=oprf_without_filtering, selected_method_name='oprf', analysis = '03', sub='002', ses='003', groundtruth_position=groundtruth_positions[1], groundtruth_sigma=groundtruth_sigmas[1])
# #...with filtering
# oprf_with_filtering = PRF.from_docker('', '002', '003', task, '01', analysis='04', hemi=hemi, baseP=basePath, orientation='MP', method='oprf')
# create_and_save_plot(result_path_seperator= slash_or_hyphen, selected_method=oprf_with_filtering, selected_method_name='oprf', analysis = '04', sub='002', ses='003', groundtruth_position=groundtruth_positions[1], groundtruth_sigma=groundtruth_sigmas[1])
...
for sub in subjects:
    for ses in sessions:    
        ...
        # oprf = PRF.from_docker('', sub, ses, task, '01', analysis=analysis_oprf, hemi=hemi, baseP=basePath, orientation='MP', method='oprf') # <----Changed to 'MP'
        ...
        # create_and_save_plot(result_path_seperator= slash_or_hyphen, selected_method=oprf, selected_method_name='oprf', analysis = analysis_oprf, sub=sub, ses=ses, groundtruth_position=groundtruth_positions[counter], groundtruth_sigma=groundtruth_sigmas[counter])        
