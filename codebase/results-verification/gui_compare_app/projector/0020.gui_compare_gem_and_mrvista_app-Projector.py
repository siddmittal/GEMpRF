...
covmap_figure_gem = Figure(figsize=(3, 2.5), dpi=80)
covmap_canvas_gem = FigureCanvasTkAgg(covmap_figure_gem, master=root)
covmap_canvas_gem.get_tk_widget().grid(row=11, column=0, columnspan=2)

# Covmap plot area - Vista
covmap_figure_vista = Figure(figsize=(3, 2.5), dpi=80)
covmap_canvas_vista = FigureCanvasTkAgg(covmap_figure_vista, master=root)
covmap_canvas_vista.get_tk_widget().grid(row=11, column=2, columnspan=2)
